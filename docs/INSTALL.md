...
3. **Settings → About** bölümünü açın ve **Version** satırına dokunun.
...
1. Yazıcının mevcut firmware sürümünü **Settings → About → Version** ekranından not edin.
