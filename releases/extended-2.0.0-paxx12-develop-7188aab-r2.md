...
Snapmaker U1'in **2.0.0 rolling/develop** sürümüne, hem Snapmaker hem de isteğe bağlı **HelixScreen 1.0.0** arayüzünde Türkçe desteği ekler. Mevcut diller korunur. Bu **r2 düzeltme yayınıdır**: HelixScreen kurucusu düşük bellekli cihazlarda büyük ikiliyi akış halinde işler. Önceki r1 paketi korunmuş tarihçe kaydıdır; yeni kurulumlarda r2 kullanılmalıdır. Ücretsiz ve kâr amacı gütmeyen, resmî olmayan bir topluluk çalışmasıdır.
...
- SHA-256: `828588305BAA882CBA676A0066D5411174B55C867E0318AEDA4EE1A90C599DCB`
